...
/*! create the view for glkview. */
- (id)initWithGLKView:(GLKView*)view delegate:(TBExampleVideoRender*)delegate;

/*! Frames are received on a separate thread, so we poll for current frame using a refresh rate proportional to screen refresh frequency. This occurs on the main thread. */
