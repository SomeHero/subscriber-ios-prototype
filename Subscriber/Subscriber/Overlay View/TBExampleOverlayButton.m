    ...
    if (self = [super initWithFrame:frame]) {
        ...
        switch (buttonType) {
            case TBExampleOverlayButtonTypeMuteButton:
                _imgButtonStateUp =
                [UIImage imageNamed:@"unmuteSubscriber.png"];
                _imgButtonStateSelected =
                [UIImage imageNamed:@"muteSubscriber.png"];
                
                break;
                
            case TBExampleOverlayButtonTypeSwitchCameraButton:
                _imgButtonStateUp =
                [UIImage imageNamed:@"swapCamera.png"];
                
                break;
                
            case TBExampleOverlayButtonTypeVolumeButton:
                _imgButtonStateUp =
                [UIImage imageNamed:@"unmutePublisher.png"];
                _imgButtonStateSelected =
                [UIImage imageNamed:@"mutePublisher.png"];

                break;
                
            default:
                _imgButtonStateUp =
                [UIImage imageNamed:@"1462361252_Stop1NormalRed"];
                _imgButtonStateSelected =
                [UIImage imageNamed:@"1462361303_Stop1Disabled"];
                break;
        }        
